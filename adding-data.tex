...
Let us now consider a nested infinite sequence of data sites,
$$
X=Y_1\subset Y_2 \subset Y_3 \subset \cdots
$$
and the associated infinite sequence~$\{s_{Y_n, f}\}_{n\in\N}$ of interpolants on those data sites of a function~$f\in\Cal N_Φ$.
