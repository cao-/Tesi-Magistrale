...
that is the matrix
$$
\Bm A_t=\pmatrix{B_1(c_1(t)) & B_2(c_1(t)) & \dots & B_N(c_1(t))\cr
		                  B_1(c_2(t)) & B_2(c_2(t)) & \dots & B_N(c_2(t))\cr
		                  B_1(x_3) & B_2(x_3) & \dots & B_N(x_3)\cr
		                  B_1(x_4) & B_2(x_4) & \dots & B_N(x_4)\cr
		 		\vdots      & \vdots     & \ddots& \vdots    \cr
		 		B_1(x_N) & B_2(x_N) & \dots & B_N(x_N)}\mathbox.
$$ 
Notice that~$X_t$ has $N$ distinct elements for all~$t$, because of the property of the two curves~$c_1$, $c_2$, so it is indeed a legitimate set of locations of size~$N$.
