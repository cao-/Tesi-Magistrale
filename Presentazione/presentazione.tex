...
\begin{frame}
\line{\kern-.3cm
\includegraphics[width=.5\hsize]{reg_sin.pdf}
\hss
\raise1.2cm\vbox{%
\hbox{\small$\Cal C^0$}
\kern1.2cm
...
\hss
\includegraphics[width=.5\hsize]{reg_disc1.pdf}}
\end{frame}


\begin{frame}
\line{\kern-.3cm
\includegraphics[width=.5\hsize]{reg_abs.pdf}
\hss
\raise1.2cm\vbox{%
\hbox{\small$\Cal C^0$}
\kern1.2cm
...
\hss
\includegraphics[width=.5\hsize]{reg_c1notc2.pdf}}
\end{frame}
...
\null\vskip.2cm
\foreach \i in {1,2,...,31}{
\only<\i>{\line{\hfil\includegraphics[width=.65\hsize]{anim_\i.pdf}\hfil}}
}
\end{frame}
...
\line{%
\kern-1cm
\includegraphics[width=.57\hsize]{f1_ori.pdf}
\hss
\includegraphics[width=.53\hsize]{f1.pdf}}
\vskip.5cm
\line{\small\hfil$h_1(x,y) = \begin{cases}\franke(x,y), & \text{if $y\geq \frac12-\frac15\sin(5x)$} \\
...
\line{%
\kern-1cm
\includegraphics[width=.57\hsize]{f4_ori.pdf}
\hss
\includegraphics[width=.53\hsize]{f4.pdf}}
\vskip.5cm
\line{\small\hfil$h_2(x,y) = \begin{cases}x^2, & \text{se $(x-\frac12)^2+(y-\frac12)^2<(\frac15)^2$} \\
...
\line{%
\kern-1cm
\includegraphics[width=.57\hsize]{f9_ori.pdf}
\hss
\includegraphics[width=.53\hsize]{f9.pdf}}
\vskip.5cm
\line{\small\hfil$h_3(x,y) = h_1(x,y) + 2h_1(x, y-{\textstyle\frac13})$\hfil}
...
\includegraphics[width=.53\hsize]{f9.pdf}}
\vskip.5cm
\line{\small\hfil$h_4(x,y) = \left|\frac12-xy\right|$\hfil}
