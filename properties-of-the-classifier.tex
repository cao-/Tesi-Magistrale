...
$$
\Bm C =  ε^{-p}\,\smash{\hbox{\setff{swsh}\bm C}}{}_{\Bm{--p}} + ε^{-p+1}\,\smash{\hbox{\setff{swsh}\bm C}}{}_{\Bm{--p+}\Bm 1} + ε^{-p+2}\,\smash{\hbox{\setff{swsh}\bm C}}{}_{\Bm{--p+}\Bm 2} + ε^{-p+3}\,\smash{\hbox{\setff{swsh}\bm C}}{}_{\Bm{--p+}\Bm 3} + \cdots,
$$
...
This means that near~$ε=0$ the matrix~$\Bm C$ is just like the first term~$ε^{-p}\,\smash{\hbox{\setff{swsh}\bm C}}{}_{\Bm{--p}}$ of its Laurent series, therefore the ratio of two elements of~$\Bm C$ is equal to the ratio of their corresponding elements in~$\smash{\hbox{\setff{swsh}\bm C}}{}_{\Bm{--p}}$ when $ε\to 0$.  More formally, for each $i,j,k,l$,
$$
\lim_{ε\to 0} {C_{i,j}\over C_{k,l}} = \lim_{ε\to 0} {ε^{-p}\,(\smash{\mathbox{\setff{swsh}\EBGaramond\it C}}{}_{-p})_{i,j} + ε^{-p+1}\,(\smash{\mathbox{\setff{swsh}\EBGaramond\it C}}{}_{-p+1})_{i,j} + \cdots \over  ε^{-p}\,(\smash{\mathbox{\setff{swsh}\EBGaramond\it C}}{}_{-p})_{k,l} + ε^{-p+1}\,(\smash{\mathbox{\setff{swsh}\EBGaramond\it C}}{}_{-p+1})_{k,l} + \cdots} = {(\smash{\mathbox{\setff{swsh}\EBGaramond\it C}}{}_{-p})_{i,j}\over (\smash{\mathbox{\setff{swsh}\EBGaramond\it C}}{}_{-p})_{k,l}}.~\QED
$$
\postskip
