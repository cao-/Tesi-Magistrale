...
Actually, as it is clear from the proof, the scaling parameter~$r$ could also have been taken negative.  But this case is already included in the next result.
